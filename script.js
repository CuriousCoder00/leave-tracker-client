document.addEventListener("DOMContentLoaded", function() {
    ...
    async function fetchLeaveHistory() {
        try {
            const response = await fetch("https://leave-tracker-server.netlify.app/leave-history");
    ...
    leaveForm.addEventListener("submit", async function(event) {
        ...
        try {
            ...
            const response = await fetch("https://leave-tracker-server.netlify.app/submit", {
                method: "POST",
                headers: {
